...
ALL_TOOLS = [
    ...
    # ── Group 2a — Document ──────────────────────────────────────────────
    {
        ...
        "description": (
            ...
            "The embedding must be pre-generated by the caller. "
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "embedding": {
                    "type": "array",
                    "items": {"type": "number"},
                    "description": "Pre-generated vector for content_text. Use [0.1, 0.2, 0.3] as placeholder in tests.",
                },
            ...
            "required": ["content_text", "source_type_id", "embedding"],
        },
    },
    {
        "name": "get_document",
        ...
        "input_schema": {
            ...
            "properties": {
                "embedding": {
                    "type": "array",
                    "items": {"type": "number"},
                    "description": "Query vector. Use [0.1, 0.2, 0.3] as placeholder.",
                },
                "person_id": {"type": "string"},
                "household_id": {"type": "string"},
                "source_type_id": {"type": "string"},
    ...
    # ── Group 2b — Fact ──────────────────────────────────────────────────
    {
        ...
        "description": (
            ...
            "The embedding should represent the merged current state of the entity."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                ...
                "embedding": {
                    "type": "array",
                    "items": {"type": "number"},
                    "description": "Vector for merged current entity state. Use [0.1, 0.2, 0.3] as placeholder.",
                },
            },
            "required": ["document_id", "schema_id", "entity_instance_id", "operation_type", "fields", "embedding"],
        },
    },
    {
